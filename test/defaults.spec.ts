...
describe('defaluts', () => {
  ...
  test('should use global defaults cofnig', () => {
    axios('/foo')
  ...
  test('should use default config for custom instance', () => {
    ...
    return getAjaxRequest().then(reqeust => {
      expect(reqeust.requestHeaders[instance.defaults.xsrfHeaderName!]).toBe('foobarbaz')
      document.cookie =
