...
describe('mergeConfig', () => {
  ...
  test('should return default headers if pass config2 width undefined', () => {
  ...
  test('should overwrite auth, headers width a non-object value', () => {
    expect(
      mergeConfig(
        {
          headers: {
