import { isAbsoluteURL, isURLSameOrigin, buildURL, combineURL } from '../../src/helpers/url'
...
describe('helper:url', () => {
  describe('buildURL', () => {
    ...
    test('should support date params', () => {
      ...
      ).toBe('/foo?time=' + time.toISOString())
    })
  ...
  describe('isAbsoluteURL', () => {
    test('should return true if URL begins width valid scheme name', () => {
      expect(isAbsoluteURL('https://stacksweet.com/react/')).toBeTruthy()
      expect(isAbsoluteURL('custom-scheme-v1.0://example.com/')).toBeTruthy()
      expect(isAbsoluteURL('HTTP://example.com/')).toBeTruthy()
    })

    test('should return false if URL begins width invalid scheme name', () => {
